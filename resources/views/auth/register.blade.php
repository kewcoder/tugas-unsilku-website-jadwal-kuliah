                ...
                <form method="POST" action="{{ route('register') }}">
                  ...
                  <div class="form-group">
                    <div class="input-group input-group-alternative mb-3">
                      ...
                      <input required name="id_kampus" class="form-control" placeholder="NPM or NIDN" type="text">
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="input-group input-group-alternative mb-3">
                      ...
                      <input required name="name" class="form-control" placeholder="Name" type="text">
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="input-group input-group-alternative mb-3">
                  ...
                  <div class="form-group">
                    <div class="input-group input-group-alternative">
                      ...
                      <input required name="password" class="form-control" placeholder="Password" type="text">
                    </div>
                  </div>
